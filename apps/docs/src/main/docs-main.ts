...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 Redrob:请点击下方「登录 Redrob」完成登录后重试',
  ...
  ja: {
    ...
    errGskNotLoggedIn:
      'Redrob にサインインしていません。下の「Redrob にサインイン」からサインインして再試行してください',
  ...
  ko: {
    ...
    errGskNotLoggedIn:
      'Redrob에 로그인되어 있지 않습니다. 아래 "Redrob 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
  ...
  de: {
    ...
    menuDocsHelp: 'Redrob Docs-Hilfe',
  },
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en Redrob: pulsa «Iniciar sesión en Redrob» abajo, inicia sesión y vuelve a intentarlo',
    ...
    menuDocsHelp: 'Ayuda de Redrob Docs',
  },
  th: {
    ...
    errGskNotLoggedIn:
      'ยังไม่ได้ลงชื่อเข้าใช้ Redrob: แตะ “ลงชื่อเข้าใช้ Redrob” ด้านล่าง แล้วลองอีกครั้ง',
    ...
    menuDocsHelp: 'วิธีใช้ Redrob Docs',
  },
  id: {
    ...
    menuDocsHelp: 'Bantuan Redrob Docs',
  },
  ru: {
    ...
    menuDocsHelp: 'Справка Redrob Docs',
  },
  ar: {
    ...
    menuDocsHelp: 'تعليمات Redrob Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuDocsHelp: 'Ajuda do Redrob Docs',
  },
  it: {
    ...
    menuDocsHelp: 'Guida di Redrob Docs',
  },
  pl: {
    ...
    menuDocsHelp: 'Pomoc Redrob Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuDocsHelp: 'עזרה של Redrob Docs',
  },
  hi: {
    ...
    menuDocsHelp: 'Redrob Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    errGskNotLoggedIn: '未登入 Redrob:請點擊下方「登入 Redrob」完成登入後重試',
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/Redrob Office. */
...
export function startDocsStandalone(): void {
  ...
  // the installed Redrob Docs is open and forwards its argv there instead.
  ...
  else if (isDev) app.setPath('userData', join(app.getPath('appData'), 'Redrob Docs Dev'))
