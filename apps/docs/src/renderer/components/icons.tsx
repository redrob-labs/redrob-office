...
/** Redrob brand mark (the chevron mark), inline so it renders crisply at device
 * resolution instead of going through <img> rasterization. Drawn in currentColor
 * so it inherits the surrounding text color. (Identifier kept as GensparkMark to
 * avoid churn across the many call sites; the artwork is the Redrob mark.) */
