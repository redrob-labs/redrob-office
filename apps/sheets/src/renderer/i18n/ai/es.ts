...
export const es = {
  ...
  aiGensparkAccount: 'Cuenta de Redrob',
  aiAccountChecking: 'Comprobando…',
  aiLoggedIn: 'Sesión iniciada',
  aiLoggedInAs: 'Sesión iniciada: {email}',
  aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de Redrob)',
  aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
  aiLoginGenspark: 'Iniciar sesión en Redrob',
  aiModel: 'Modelo',
  aiCancel: 'Cancelar',
  aiSave: 'Guardar',
