...
export const strings = {
  zh: {
    ...
    onbTitle1: '欢迎使用 Redrob',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Redrob 目前处于 alpha 阶段。欢迎加入 Redrob 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '你的反馈将 **塑造下一步的方向**',
    onbJoinGenTeam: '加入 Redrob',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    onbBody2:
      'Redrob is still in alpha. Join the group chat on Redrob to share feedback and help shape what comes next.',
    onbCredits: 'Your feedback **shapes what we build next**',
    onbJoinGenTeam: 'Join Redrob',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  fr: {
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Redrob',
    ...
    onbBody2:
      'Redrob est encore en alpha. Rejoignez la discussion de groupe sur Redrob pour partager vos retours et façonner la suite.',
    onbCredits: 'Vos retours **façonnent la suite**',
    onbJoinGenTeam: 'Rejoindre Redrob',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Redrob',
    ...
    onbBody2:
      'Redrob ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Redrob bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Dein Feedback **prägt die nächsten Schritte**',
    onbJoinGenTeam: 'Redrob beitreten',
  ...
  es: {
    ...
    onbBody2:
      'Redrob aún está en alfa. Únete al chat grupal en Redrob para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Tus comentarios **definen lo que construimos**',
    onbJoinGenTeam: 'Unirse a Redrob',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Redrob',
    ...
    onbBody2:
      'Redrob ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Redrob เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ความคิดเห็นของคุณ **กำหนดสิ่งที่เราจะสร้างต่อไป**',
    onbJoinGenTeam: 'เข้าร่วม Redrob',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Redrob',
    ...
    onbBody2:
      'Redrob masih dalam tahap alpha. Gabung obrolan grup di Redrob untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Masukan Anda **membentuk arah berikutnya**',
    onbJoinGenTeam: 'Gabung Redrob',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Redrob',
    ...
    onbBody2:
      'Redrob пока в альфа-версии. Присоединяйтесь к групповому чату в Redrob, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Ваши отзывы **определяют дальнейшее развитие**',
    onbJoinGenTeam: 'Присоединиться к Redrob',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    onbBody2:
      'لا يزال Redrob في مرحلة ألفا. انضم إلى الدردشة الجماعية على Redrob لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'ملاحظاتك **تحدد ما نبنيه لاحقًا**',
    onbJoinGenTeam: 'الانضمام إلى Redrob',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    onbBody2:
      'O Redrob ainda está em alfa. Entre no chat em grupo no Redrob para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Seu feedback **molda o que construímos**',
    onbJoinGenTeam: 'Entrar no Redrob',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    onbBody2:
      'Redrob è ancora in alpha. Unisciti alla chat di gruppo su Redrob per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'Il tuo feedback **guida i prossimi passi**',
    onbJoinGenTeam: 'Unisciti a Redrob',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    onbBody2:
      'Redrob jest wciąż w fazie alfa. Dołącz do czatu grupowego na Redrob, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Twoja opinia **kształtuje kolejne kroki**',
    onbJoinGenTeam: 'Dołącz do Redrob',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    onbBody2:
      'Redrob is nog in alfa. Doe mee aan de groepschat op Redrob om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Jouw feedback **bepaalt wat we hierna bouwen**',
    onbJoinGenTeam: 'Word lid van Redrob',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Redrob',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Redrob masih dalam peringkat alfa. Sertai sembang kumpulan di Redrob untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Maklum balas anda **membentuk hala tuju seterusnya**',
    onbJoinGenTeam: 'Sertai Redrob',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Redrob',
    ...
    onbBody2:
      'Redrob עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Redrob כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'המשוב שלך **מעצב את הצעד הבא**',
    onbJoinGenTeam: 'הצטרפו ל-Redrob',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Redrob में आपका स्वागत है',
    ...
    onbBody2:
      'Redrob अभी अल्फ़ा में है। Redrob पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'आपकी प्रतिक्रिया **आगे की दिशा तय करती है**',
    onbJoinGenTeam: 'Redrob से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Redrob',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Redrob 目前仍在 alpha 階段。歡迎加入 Redrob 群聊，分享回饋，一起打造它的未來。',
