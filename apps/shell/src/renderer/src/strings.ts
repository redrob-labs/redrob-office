...
export const strings = {
  zh: {
    ...
    setAiConnect: 'Connect Redrob',
    setAiConnectDesc: 'Approve a short code in Console instead of pasting a key.',
    setAiConnectCode: 'Approve {code} in Console to finish connecting.',
    setAiConnectWaiting: 'Waiting for approval in Console…',
    setAiConnectDone: 'Connected. The key is stored on this device.',
    setAiConnectFailed: 'Could not connect: {reason}',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
  ...
  ko: {
    ...
    setAiConnect: 'Redrob 연결',
    setAiConnectDesc: '키를 붙여 넣는 대신 콘솔에서 짧은 코드를 승인합니다.',
    setAiConnectCode: '콘솔에서 {code} 를 승인하면 연결이 끝납니다.',
    setAiConnectWaiting: '콘솔에서 승인을 기다리고 있습니다…',
    setAiConnectDone: '연결됐습니다. 키는 이 기기에만 저장됩니다.',
    setAiConnectFailed: '연결하지 못했습니다: {reason}',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
