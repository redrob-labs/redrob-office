...
export const strings = {
  zh: {
    ...
    setAiGensparkHint: '使用 Redrob 账号登录，无需 API key。',
    ...
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具仍需登录 Redrob。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    setAiGskTools: 'Redrob 云工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经 Redrob 云端并消耗积分；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
  ...
  en: {
    ...
    setAiGensparkHint: 'Uses your Redrob sign-in; no API key needed.',
    ...
    setAiByokNote:
      'Chats use your own key; cloud tools (web search, image generation) still require the Redrob sign-in.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiGskTools: 'Redrob cloud tools',
    setAiGskToolsDesc:
      'Web search, AI image generation and media analysis run through Redrob and use credits; when off, image tools are unavailable and search uses free sources.',
  ...
  ja: {
    ...
    setAiGensparkHint: 'Redrob アカウントでサインインするため、API キーは不要です。',
    ...
    setAiByokNote:
      'チャットは自分のキーを使用します。ウェブ検索や画像生成などのクラウドツールには Redrob へのサインインが必要です。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiGskTools: 'Redrob クラウドツール',
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析は Redrob クラウド経由でクレジットを消費します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
  ...
  ko: {
    ...
    setAiGensparkHint: 'Redrob 로그인으로 사용하며 API 키가 필요 없습니다.',
    ...
    setAiByokNote:
      '대화는 자신의 키를 사용합니다. 웹 검색·이미지 생성 등 클라우드 도구는 여전히 Redrob 로그인이 필요합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiGskTools: 'Redrob 클라우드 도구',
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은 Redrob 클라우드를 거치며 크레딧을 사용합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
  ...
  fr: {
    ...
    setAiGensparkHint: 'Utilise votre connexion Redrob ; aucune clé API requise.',
    ...
    setAiByokNote:
      "Les conversations utilisent votre propre clé ; les outils cloud (recherche web, génération d'images) nécessitent toujours la connexion Redrob.",
    ...
    setAiGskTools: 'Outils cloud Redrob',
    setAiGskToolsDesc:
      "Recherche web, génération d'images et analyse de médias passent par Redrob et consomment des crédits ; désactivé, les outils d'image sont indisponibles et la recherche utilise des sources gratuites.",
    setGithub: 'Open source',
  ...
  de: {
    ...
    setAiGensparkHint: 'Nutzt Ihre Redrob-Anmeldung; kein API-Schlüssel nötig.',
    ...
    setAiByokNote:
      'Chats verwenden Ihren eigenen Schlüssel; Cloud-Tools (Websuche, Bilderzeugung) erfordern weiterhin die Redrob-Anmeldung.',
    setAiSave: 'Speichern',
    ...
    setAiGskTools: 'Redrob-Cloud-Tools',
    setAiGskToolsDesc:
      'Websuche, KI-Bilderzeugung und Medienanalyse laufen über Redrob und verbrauchen Guthaben; ausgeschaltet sind Bildtools nicht verfügbar und die Suche nutzt freie Quellen.',
    setGithub: 'Open Source',
  ...
  es: {
    ...
    setAiGensparkHint: 'Usa tu inicio de sesión de Redrob; no se necesita clave de API.',
    ...
    setAiByokNote:
      'Los chats usan tu propia clave; las herramientas en la nube (búsqueda web, generación de imágenes) siguen requiriendo el inicio de sesión de Redrob.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiGskTools: 'Herramientas en la nube de Redrob',
    setAiGskToolsDesc:
      'La búsqueda web, la generación de imágenes y el análisis de medios pasan por Redrob y consumen créditos; desactivado, las herramientas de imagen no están disponibles y la búsqueda usa fuentes gratuitas.',
  ...
  th: {
    ...
    setAiGensparkHint: 'ใช้การลงชื่อเข้าใช้ Redrob ไม่ต้องใช้คีย์ API',
    ...
    setAiByokNote:
      'แชทใช้คีย์ของคุณเอง เครื่องมือคลาวด์ (ค้นเว็บ สร้างภาพ) ยังต้องลงชื่อเข้าใช้ Redrob',
    setAiSave: 'บันทึก',
    ...
    setAiGskTools: 'เครื่องมือคลาวด์ Redrob',
    setAiGskToolsDesc:
      'ค้นเว็บ สร้างภาพ AI และวิเคราะห์สื่อผ่านคลาวด์ Redrob และใช้เครดิต ปิดแล้วเครื่องมือภาพจะใช้ไม่ได้ และการค้นหาใช้แหล่งฟรี',
  ...
  id: {
    ...
    setAiGensparkHint: 'Menggunakan login Redrob; tanpa kunci API.',
    ...
    setAiByokNote:
      'Obrolan memakai kunci Anda sendiri; alat cloud (pencarian web, pembuatan gambar) tetap memerlukan login Redrob.',
    setAiSave: 'Simpan',
    ...
    setAiGskTools: 'Alat cloud Redrob',
    setAiGskToolsDesc:
      'Pencarian web, pembuatan gambar AI, dan analisis media berjalan lewat Redrob dan memakai kredit; jika dimatikan, alat gambar tidak tersedia dan pencarian memakai sumber gratis.',
  ...
  ru: {
    ...
    setAiGensparkHint: 'Использует вход в Redrob; ключ API не нужен.',
    ...
    setAiByokNote:
      'Чаты используют ваш собственный ключ; облачные инструменты (веб-поиск, генерация изображений) по-прежнему требуют входа в Redrob.',
    setAiSave: 'Сохранить',
    ...
    setAiGskTools: 'Облачные инструменты Redrob',
    setAiGskToolsDesc:
      'Веб-поиск, генерация изображений и анализ медиа идут через Redrob и расходуют кредиты; при отключении инструменты изображений недоступны, а поиск использует бесплатные источники.',
  ...
  ar: {
    ...
    setAiGensparkHint: 'يستخدم تسجيل الدخول إلى Redrob؛ لا حاجة لمفتاح API.',
    ...
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول إلى Redrob.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiGskTools: 'أدوات Redrob السحابية',
    setAiGskToolsDesc:
      'يمر بحث الويب وتوليد الصور وتحليل الوسائط عبر سحابة Redrob ويستهلك الرصيد؛ عند الإيقاف تصبح أدوات الصور غير متاحة ويستخدم البحث مصادر مجانية.',
  ...
  pt: {
    ...
    setAiGensparkHint: 'Usa seu login Redrob; nenhuma chave de API necessária.',
    ...
    setAiByokNote:
      'Os chats usam sua própria chave; as ferramentas na nuvem (busca na web, geração de imagens) ainda exigem o login Redrob.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiGskTools: 'Ferramentas na nuvem Redrob',
    setAiGskToolsDesc:
      'Busca na web, geração de imagens e análise de mídia passam pela Redrob e consomem créditos; desligado, as ferramentas de imagem ficam indisponíveis e a busca usa fontes gratuitas.',
  ...
  it: {
    ...
    setAiGensparkHint: 'Usa il tuo accesso Redrob; nessuna chiave API richiesta.',
    ...
    setAiByokNote:
      "Le chat usano la tua chiave; gli strumenti cloud (ricerca web, generazione immagini) richiedono comunque l'accesso Redrob.",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiGskTools: 'Strumenti cloud Redrob',
    setAiGskToolsDesc:
      'Ricerca web, generazione di immagini e analisi dei media passano da Redrob e consumano crediti; se disattivato, gli strumenti immagine non sono disponibili e la ricerca usa fonti gratuite.',
    setGithub: 'Open source',
  ...
  pl: {
    ...
    setAiGensparkHint: 'Korzysta z logowania Redrob; klucz API nie jest potrzebny.',
    ...
    setAiByokNote:
      'Czaty używają Twojego klucza; narzędzia w chmurze (wyszukiwanie, generowanie obrazów) nadal wymagają logowania Redrob.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiGskTools: 'Narzędzia chmurowe Redrob',
    setAiGskToolsDesc:
      'Wyszukiwanie w sieci, generowanie obrazów AI i analiza mediów przechodzą przez Redrob i zużywają kredyty; po wyłączeniu narzędzia obrazów są niedostępne, a wyszukiwanie korzysta z darmowych źródeł.',
    setGithub: 'Open source',
  ...
  nl: {
    ...
    setAiGensparkHint: 'Gebruikt je Redrob-login; geen API-sleutel nodig.',
    ...
    setAiByokNote:
      'Chats gebruiken je eigen sleutel; cloudtools (webzoeken, beeldgeneratie) vereisen nog steeds de Redrob-login.',
    setAiSave: 'Opslaan',
    ...
    setAiGskTools: 'Redrob-cloudtools',
    setAiGskToolsDesc:
      'Webzoeken, AI-beeldgeneratie en media-analyse lopen via Redrob en verbruiken tegoed; uitgeschakeld zijn beeldtools niet beschikbaar en gebruikt zoeken gratis bronnen.',
    setGithub: 'Open source',
  ...
  ms: {
    ...
    setAiGensparkHint: 'Menggunakan log masuk Redrob; tiada kunci API diperlukan.',
    ...
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri; alat awan (carian web, penjanaan imej) masih memerlukan log masuk Redrob.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiGskTools: 'Alat awan Redrob',
    setAiGskToolsDesc:
      'Carian web, penjanaan imej AI dan analisis media melalui awan Redrob dan menggunakan kredit; jika dimatikan, alat imej tidak tersedia dan carian menggunakan sumber percuma.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka Redrob?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Redrob',
  ...
  he: {
    ...
    setAiGensparkHint: 'משתמש בכניסת Redrob שלך; אין צורך במפתח API.',
    ...
    setAiByokNote:
      'שיחות משתמשות במפתח שלך; כלי ענן (חיפוש ברשת, יצירת תמונות) עדיין דורשים כניסת Redrob.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiGskTools: 'כלי הענן של Redrob',
    setAiGskToolsDesc:
      'חיפוש ברשת, יצירת תמונות וניתוח מדיה עוברים דרך Redrob וצורכים קרדיטים; בכיבוי, כלי התמונות אינם זמינים והחיפוש משתמש במקורות חינמיים.',
    setGithub: 'קוד פתוח',
  ...
  hi: {
    ...
    setAiGensparkHint: 'आपके Redrob साइन-इन का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    ...
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं; क्लाउड टूल (वेब खोज, छवि निर्माण) के लिए अभी भी Redrob साइन-इन आवश्यक है।',
    setAiSave: 'सहेजें',
    ...
    setAiGskTools: 'Redrob क्लाउड टूल',
    setAiGskToolsDesc:
      'वेब खोज, AI छवि निर्माण और मीडिया विश्लेषण Redrob क्लाउड से होते हैं और क्रेडिट खर्च करते हैं; बंद करने पर छवि टूल अनुपलब्ध होंगे और खोज मुफ्त स्रोतों का उपयोग करेगी।',
    setGithub: 'ओपन सोर्स',
  ...
  'zh-TW': {
    ...
    setAiGensparkHint: '使用 Redrob 帳號登入，無需 API key。',
    ...
    setAiByokNote: '對話使用你自己的 key；網頁搜尋、生圖等雲端工具仍需登入 Redrob。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    ...
    setAiGskTools: 'Redrob 雲端工具',
    setAiGskToolsDesc:
      '網頁搜尋、AI 生圖、媒體分析經 Redrob 雲端並消耗點數；關閉後生圖與媒體分析不可用，搜尋改用免費來源。',
    setGithub: '開源專案',
